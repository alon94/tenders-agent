...
export const DOMAINS: DomainDef[] = [
  ...
  { id: "construction", label: "בינוי ותשתיות", kw: ["בינוי", "בנייה", "בניה", "תשתיות", "תשתית", "קבלן", "שיפוץ", "ביוב", "מים", "כבישים", "אדריכל", "עבודות", "סלילה", "הנדס", "חשמל", "מיזוג", "אינסטלציה", "גשר", "מבנה"] },
  ...
  { id: "transport", label: "הסעות ולוגיסטיקה", kw: ["הסעות", "הסעה", "תחבורה", "לוגיסטיקה", "לוגיסטי", "הובלה", "שינוע", "רכב", "אוטובוס", "משאית", "אחסנה", "בלדרות"] },
...
export const PUBLISHERS: PublisherDef[] = [
  { id: "gov", label: "משרדי ממשלה", kw: ["משרד", "רשות", "מינהל", "אגף", "ממשלת", "ממשלה", "מדינה"] },
  ...
  { id: "infra", label: "חברות ממשלתיות", kw: ["חברת חשמל", "מקורות", "נמלים", "רכבת", "נתיבי", "נמל"] },
];
