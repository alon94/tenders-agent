...
const NAV_TITLE_JUNK = /^(מכרזים( ודרושים| פעילים| פומביים| סגורים| והתקשרויות| והודעות| וקולות קוראים)?|מכרזי (חוף [\u0590-\u05ff ]{2,12}|כו?ח אדם|משאבי אנוש|שירותים ותשתיות|העירייה|רכש|נכסים|מקרקעין)|ועדת מכרזים|ארכיון מכרזים|מסמכי המכרז|תוצאות מכרזים( עירוניים)?|דפי מכרזים|פרוטוקולים? ועדת מכרזים|כל המכרזים|לכל המכרזים|רשימת המכרזים|מכרזים ודרושים|מכרזים ורכש|מכרזים\/רכש|ארכיון [\u0590-\u05ff ]{3,30}|פטורים? ממכרז)\s*[›>»]?\s*$/;
